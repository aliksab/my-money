                ...
                <section className="h-screen items-center dark:bg-gray-800 dark:text-gray-100">
                    ...
                    <div className="container relative z-10 mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
                        ...
                        <div className="flex flex-wrap justify-center">
                            <Button><NavLink to="/api">Поехали</NavLink></Button>
                        </div>
                    </div>

                    <div className="flex fixed w-screen justify-between top-1/2 opacity-40">
                        <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[8px] rounded h-[172px] max-w-[301px] md:h-[294px] md:max-w-[512px]">
                        ...
                        <div className="relative overflow-hidden mx-auto border-gray-800 dark:border-white bg-gray-800 dark:bg-white border-[14px] rounded-[2.5rem] h-[600px] w-[300px]">
